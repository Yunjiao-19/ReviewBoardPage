...
class TestCase(FixturesCompilerMixin, DjbletsTestCase):
    ...
    def create_read_status(self):
         """Create a ReadStatus for testing.

        Args:
            

        Returns:
            reviewboard.reviews.models.read_status.ReadStatus:
            The newly-created read status.
        """
    ...
    def create_commit_message_comment(self, review, commit,
                             text='My comment', issue_opened=False,
                             issue_status=None, extra_fields=None, 
                             reply_to=None, **kwargs):
         """Create a CommitMessageComment for testing.

         The comment is tied to a commit message of the given Review. It is 
         populated with default data that can be overridden by the caller.
         ...
         Args:
             ...
             commit (reviewboard.diffviewer.models.diffcommit.DiffCommit):
                 The commit associated with the comment.
             ...
             reply_to (reviewboard.reviews.models.commit_message_comment.
                       CommitMessageComment, optional):
                 The comment this comment replies to.
         ...
         Returns:
             reviewboard.reviews.models.commit_message_comment.CommitMessageComment:
             The resulting comment.
         """
         if issue_opened and not issue_status:
             issue_status = CommitMessageComment.OPEN

         comment = CommitMessageComment(
             commit=commit,
             text=text,
             issue_opened=issue_opened,
             issue_status=issue_status,
         ...
         comment.save()
         review.commit_message_comments.add(comment)
