...
class ReviewAdmin(ModelAdmin):
    ...
    raw_id_fields = ('review_request', 'user', 'base_reply_to',
                     ...
                     'reviewed_diffset', 'commit_message_comments')
    fieldsets = (
        (_('General Information'), {
...
class CommitMessageCommentAdmin(ModelAdmin):
    list_display = ('text', 'commit_id', 'review_request_id', 
                    'first_line', 'num_lines', 'timestamp')
    search_fields = ['text']
    list_filter = ('timestamp',)
    raw_id_fields = ('commit_id', 'reply_to')
    ordering = ['-timestamp']
