...
class ReviewsCodeBrowserTests(TestCase):
    """Unit tests for reviewboard.reviews.views.ReviewsCodeBrowserView."""

    fixtures = ['test_users', 'test_scmtools']

    # Bug 892
    def test_codebrowser(self):
        ...
        response = self.client.get('/r/1/code/')
