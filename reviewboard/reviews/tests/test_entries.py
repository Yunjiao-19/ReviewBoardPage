...
class ReviewEntryTests(TestCase):
    ...
    def test_build_entries(self):
        ...
        self.create_general_comment(review3,
                                    ...
                                    "extra_data":{"beginLineNum":14,
                                    "endLineNum":14,"parentComments":"{}",
                                    "require_verification":false,
                                    "viewMode":"source"},"id":142,
                                    "issue_opened":true,"issue_status":"open",
                                    "link_text":"test_CipherString.cc","links":
                                    {"delete":{"href":"http://localhost:8080/
                                    api/review-requests/13/reviews/60/
                                    file-attachment-comments/142/",
                                    "method":"DELETE"},"file_attachment":
                                    {"href":"http://localhost:8080/api/
                                    review-requests/13/file-attachments/19/",
                                    "method":"GET","title":"test_CipherString.
                                    cc"},"self":{"href":"http://localhost:8080/
                                    api/review-requests/13/reviews/60/
                                    file-attachment-comments/142/",
                                    "method":"GET"},"update":{"href":"http://
                                    localhost:8080/api/review-requests/13/
                                    reviews/60/file-attachment-comments/142/",
                                    "method":"PUT"},"user":{"href":"http://
                                    localhost:8080/api/users/erinb922/",
                                    "method":"GET","title":"erinb922"}},
                                    "public":true,"review_url":"/r/13/
                                    #fcomment142","text":"Test comment 1",
                                    "text_type":"markdown",
                                    "thumbnail_html":"\n\n\n\n<table 
                                    class=\"sidebyside text-review-ui-table
                                    text-review-ui-comment-thumbnail \">\n 
                                    <colgroup>\n\n  <col class=\"line\" />\n 
                                    <col class=\"right\" />\n </colgroup>\n\n
                                    <tbody>\n\n  <tr>\n   <th>14</th>\n
                                    <td><pre><span class=\"w\">    </span><span
                                    class=\"n\">BOOST_AUTO_TEST_CASE</
                                    span><span class=\"p\">(</span><span 
                                    class=\"n\">testFromStringValid</span><span
