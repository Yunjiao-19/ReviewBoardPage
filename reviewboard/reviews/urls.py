...
diffviewer_revision_urls = [
    ...
    url(r'^api/blob/', views.ReviewsCodeBrowserFragmentView.as_view(),
        name='code-browser-diff-revision'),
...
codebrowser_urls = [
    url(r'^api/blob/', views.ReviewsCodeBrowserFragmentView.as_view(), name='code-browser-fragment'),

    url(r'^', views.ReviewsCodeBrowserView.as_view(), name='code-browser'),
]
...
review_request_urls = [
    ...
    # Team17;
    # New url for read status history
    url(r'history',
        views.ReadstatusHistoryView.as_view(),
        name='readstatus-history'),
    ...
    # Review request code browser
    url(r'^code/', include(codebrowser_urls)),
    ...
    url(r'^_fragments/untouched-comments/(?P<comment_ids>[\d,]+)/$',
        views.UntouchedCommentFragmentsView.as_view(),
        name='untouched-comment-fragments'),
    ...
    #Team 12: Print configurations
    url(r'^print/$',
        views.ReviewRequestPrintView.as_view(),
        name = 'print'),    
]
