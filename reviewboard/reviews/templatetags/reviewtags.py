...
# Number of prefix characters of COMMIT HASH to be shown for commit message comments
CC_COMMIT_HASH_LENGTH = 8

@register.simple_tag(takes_context=True)
def shorten_commithash(context, commithash):
    print("got text",commithash)
    return commithash[:CC_COMMIT_HASH_LENGTH]
