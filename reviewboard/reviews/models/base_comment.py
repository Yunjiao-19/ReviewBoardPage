...
class BaseComment(models.Model):
    ...
    def _get_parentComments(self):
        return self.extra_data.get('parentComments')

    def _set_parentComments(self, value):
        self.extra_data['parentComments'] = value

    parentComments = property(
        _get_parentComments, _set_parentComments,
        doc='This comment\'s parent comments.')
