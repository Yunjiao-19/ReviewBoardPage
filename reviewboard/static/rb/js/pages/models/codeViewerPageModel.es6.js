 ...
 */
 RB.CodeViewerPage = RB.ReviewablePage.extend({
    defaults: _.defaults({
    ...
    _parseDiffContext(rsp) {
        ...
        if (rsp.is_blob){
            this.is_blob=rsp.is_blob
            this.blob_content_url = rsp.blob_content_url
            this.reviewId = rsp.review_id
            this.path = rsp.code_path
            this.untouchedComments = rsp.untouched_comments
            this.untouchedFile = {
                'comment': this.untouchedComments[this.path],
                'path': this.path,
                'hashcode': rsp.hashcode
            }
        }
