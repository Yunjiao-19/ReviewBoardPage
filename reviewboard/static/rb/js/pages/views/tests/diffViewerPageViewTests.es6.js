    ...
    describe('Without commits', function() {
        ...
        describe('Anchors', function() {
            ...
            describe('Navigation', function() {
                ...
                // Team17:
                // Set the read status bar during initialization.
                describe('Read Status', function() {
                    it('Progress bar initially', function() {
                        let stats = pageView.get_readstatus_stats();
                        let realstats = {read:0, tentative:0, unread:0, total:0};
                        expect(JSON.stringify(stats)).toBe(JSON.stringify(realstats));
                    });
                });
