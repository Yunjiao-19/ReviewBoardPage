suite('rb/resources/models/BaseComment', function() {
    ...
    beforeEach(function() {
        ...
        parentComment = new RB.BaseComment({
            parentObject: new RB.BaseResource({
                'public': true,
            }),
        })
    ...
    describe('destroyIfEmpty', function() {
        ...
        it('Destroying when text is empty and parentComments are undefined ', function() {
            model.set('text', '');
        ...
        it('Not destroying when parentComments is not empty', function() {
            const parentsList = [parentComment];
            const parentCommentObj = Object.assign({}, parentsList);
            const jsonParent = JSON.stringify(parentCommentObj);
            model.setExtraData('parentComments', jsonParent);
            model.destroyIfEmpty();
            expect(model.destroy).not.toHaveBeenCalled();
        });
    });
