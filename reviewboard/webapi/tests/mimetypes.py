...
commit_message_comment_list_mimetype = _build_mimetype('review-commit-comments')
commit_message_comment_item_mimetype = _build_mimetype('review-commit-comment')
...
review_reply_commit_message_comment_list_mimetype = \
    _build_mimetype('review-reply-commit-message-comments')
review_reply_commit_message_comment_item_mimetype = \
    _build_mimetype('review-reply-commit-message-comment')
...
read_status_item_mimetype = _build_mimetype('read-status')
read_status_list_mimetype = _build_mimetype('read-statuses')
