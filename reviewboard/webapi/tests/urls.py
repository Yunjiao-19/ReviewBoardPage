...
#
# CommitMessageCommentResource
#
def get_review_commit_comment_list_url(review_request, local_site_name=None):
    return resources.base_review_commit_comment.get_list_url(
        local_site_name=local_site_name,
        review_request_id=review_request.display_id)


def get_review_commit_comment_item_url(review_request, comment_id,
                                 local_site_name=None):
    return resources.base_review_commit_comment.get_item_url(
        local_site_name=local_site_name,
        review_request_id=review_request.display_id,
...
#
# ReviewReplyCommitMessageCommentResource
#
def get_review_reply_commit_message_comment_list_url(reply, local_site_name=None):
    return resources.review_reply_commit_message_comment.get_list_url(
        local_site_name=local_site_name,
        review_request_id=reply.review_request.display_id,
        review_id=reply.base_reply_to_id,
        reply_id=reply.pk)
...
def get_review_reply_commit_message_comment_item_url(reply, comment_id,
                                              local_site_name=None):
    return resources.review_reply_commit_message_comment.get_item_url(
        local_site_name=local_site_name,
        review_request_id=reply.review_request.display_id,
        review_id=reply.base_reply_to_id,
        reply_id=reply.pk,
...
def get_read_status_item_url(review_request, local_site_name=None):
    return resources.read_status.get_item_url(
        local_site_name=local_site_name,
        review_request_id=review_request.display_id)

def get_read_status_list_url(local_site_name=None):
    return resources.read_status.get_list_url(
        local_site_name=local_site_name)
