...
class ReviewCommitCommentResource(BaseReviewCommitMessageCommentResource):
    """Provides information on commit comments made on a review.
    ...
    def get_queryset(self, request, review_id, *args, **kwargs):
        q = super(ReviewCommitCommentResource, self).get_queryset(
            request, *args, **kwargs)
    ...
    @webapi_request_fields(
        required=BaseReviewCommitMessageCommentResource.REQUIRED_CREATE_FIELDS,
        optional=BaseReviewCommitMessageCommentResource.OPTIONAL_CREATE_FIELDS,
        allow_unknown=True
    )
    def create(self, request, *args, **kwargs):
        """Creates a commit comment on a review.
        ...
        return self.create_comment(fields=(),
                                   review=review,
                                   comments_m2m=review.commit_message_comments,
                                   **kwargs)
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            review = resources.review.get_object(request, *args, **kwargs)
            commit_comment = self.get_object(request, *args, **kwargs)
        except ObjectDoesNotExist:
            return DOES_NOT_EXIST
    ...
    def get_list(self, *args, **kwargs):
        """Returns the list of commit comments made on a review."""
        pass


review_reply_commit_comment_resource = ReviewCommitCommentResource()