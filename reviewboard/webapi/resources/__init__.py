...
class Resources(ResourcesRegistry):
    ...
    def register_resources(self):
        ...
        register_resource_for_model(
            UntouchedComment,
            lambda obj: (obj.review.get().is_reply() and
                         self.review_reply_untouched_comment or
                         self.review_untouched_comment))
        
        # register_resource_for_model(UntouchedComment, self.review_untouched_comment)
        ...
        register_resource_for_model(ReadStatus, self.read_status)
