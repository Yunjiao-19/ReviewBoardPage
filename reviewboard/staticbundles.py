...
PIPELINE_JAVASCRIPT = dict({
    ...
    'js-tests': {
        'source_filenames': (
            ...
            'rb/js/resources/models/tests/commitMessageCommentModelTests.es6.js',
    ...
    'common': {
        'source_filenames': (
            ...
            'rb/js/resources/models/commitMessageCommentModel.es6.js',
            ...
            'rb/js/resources/models/untouchedCommentReplyModel.es6.js',
    ...
    'reviews': {
        'source_filenames': (
            ...
            'rb/js/pages/models/codeViewerPageModel.es6.js',
            ...
            'rb/js/diffviewer/views/codeReviewableView.es6.js',
            'rb/js/diffviewer/views/codeTextRowSelector.es6.js',
            'rb/js/diffviewer/views/codeCommentDialogView.es6.js',
...
PIPELINE_STYLESHEETS = dict({
    ...
    'print': {
        'source_filenames': (
            'rb/css/pages/print.less',
        ),
        'output_filename': 'rb/css/print.min.css',
        'absolute_paths': False,
    },
